...
# Functions to start/stop motors separately
def start_motors():
...
# Start the light sensor thread
light_sensor_thread = threading.Thread(target=light_sensor_loop, daemon=True)
