...
Course notes and reference materials for TEJ4M (Grade 12, Ontario).

---

## Unit 1: Networking

Concepts: TCP/IP model, network devices, IP and MAC addressing, ARP, DNS, DHCP, TCP vs UDP, wireless networking, diagnostics. Hands-on: Lubuntu installation, terminal fundamentals, network services deployment.
...
Concepts: Processor architecture (x86-64, ARM), Linux filesystem hierarchy, permissions and ownership, processes and services, pipes and redirection, package management. Capstone: emulator installation and technical documentation.

| # | Topic | Type |
|---|-------|------|
| 1 | [Processor Architecture](unit-2-linux/processor_architecture) | Notes |
| 2 | Filesystem Hierarchy | Notes |
| 3 | Permissions and Ownership | Notes |
