...
|---|---|---|---|
| 4×AA NiMH (1.2V × 4) | 4.8V | ~3.0V | closest match to current behaviour |
...
| Battery box black (–) | Breadboard GND rail | Same GND rail as the cobbler |
